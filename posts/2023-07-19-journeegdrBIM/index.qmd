...
Pré-requis : Pensez à installer les packages nécessaires et télécharger les données si vous souhaitez suivre le tutoriel en direct.
Toutes les infos [ici](https://github.com/AGloaguen/RGCCA4Statomique)
:::
...
::: {.callout-note appearance="simple" icon="false"}
Posters : venez avec le vôtre, qu'il soit nouveau ou déjà présenté par ailleurs, sur un travail en cours/passé, une activité plateforme, un groupe de travail, ... 
Merci de nous contacter pour la logistique.
:::
...
**Merci de vous présenter avec une pièce d'identité au bâtiment A en arrivant.**
