...
-   10h15-12h15 Arnaud Gloaguen (Centre National de Recherche en Génomique Humaine, Institut François Jacob, CEA, Université Paris-Saclay) animera un tutoriel sur l'analyse de données multi-blocs avec le [package R {RGCCA}](https://cran.r-project.org/package=RGCCA).

-   Estelle Chatelain, **Intégration de données omiques sur une cohorte de patients obèses/diabétiques**, retour d'expériences d'utilisation de `MixOmics::DIABLO` et `rgcca`.
...
-   **Session posters** (venez avec le vôtre, nous contacter pour la logistique)

-   Etienne Thévenot (CEA, INRAE, Université Paris-Saclay, MetaboHUB), **Sciences des données métabolomiques pour la santé**
...
-   Silvia Bottini, **HIVE: a novel tool for Horizontal multi-omics Integration analysis using Variational AutoEncoders**
