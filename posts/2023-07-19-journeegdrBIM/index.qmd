...
Pré-requis : Pensez à installer les packages nécessaires et télécharger les données si vous souhaitez suivre le tutoriel en direct. Toutes les infos [ici](https://github.com/AGloaguen/RGCCA4Statomique)
:::
...
::: {.callout-note appearance="simple" icon="false"}
Posters : venez avec le vôtre, qu'il soit nouveau ou déjà présenté par ailleurs, sur un travail en cours/passé, une activité plateforme, un groupe de travail, ... Merci de nous contacter pour la logistique.
:::
...
**Comment venir ?** Le métro le plus proche est **4 Cantons Grand Stade (Villeneuve d'Ascq)**. La ligne 1 est directe depuis la gare Lille Flandres. Compter ensuite 15 minutes à pied. Pour préparer votre itinéraire en métro : <https://www.ilevia.fr/>
 ...
 ![](/media/2023-gdrBiM/plan_ acces_Inria.png)
:::
